...
export const blogPosts: readonly BlogPost[] = [
  {
    ...
    header: "Open Knowledge Format (OKF): linked context for AI agents",
    description:
      "What Google Cloud's Open Knowledge Format (OKF) v0.2 is, how linked Markdown context works for AI agents, and where RAG fits alongside it.",
    keywords: [
...

  {
    ...
    keywords: [
      ...
      "Conduit AI telepathy",
      "Naomi Bashkansky AI telepathy",
      "OpenAI researcher AI telepathy",
      "non-invasive thought-to-text",
  ...
  },
  {
    ...
    date: "2026-08-02",
    writer: siteIdentity.name,
    header: "PostgreSQL permissions and database access control: roles, GRANTs",
    description:
      "A practical guide to database permissions in PostgreSQL: roles, GRANT, schema and table access, default privileges, ownership, and row-level security.",
    keywords: [
      "PostgreSQL permissions",
      "PostgreSQL roles and privileges",
      "PostgreSQL GRANT and REVOKE",
      "permission denied for table PostgreSQL",
      "PostgreSQL schema permissions",
      "PostgreSQL default privileges",
      "PostgreSQL row-level security",
      "PostgreSQL database access control",
